...
private:
    ...
    bool checkDeviceExtensionSupport(VkPhysicalDevice device)
    {
        ...
        {
            auto iter = std::remove(requiredExtensions.begin(), requiredExtensions.end(), extension.extensionName);
            requiredExtensions.erase(iter, requiredExtensions.end());
        }
    ...
    void createGraphicsPipeline()
    {
        ...
        {
            throw std::runtime_error("failed tro create graphics pipeline!");
        }
    ...
    void createTextureImage()
    {
        ...
        generateMipmap(textureImage, texWidth, texHeight, mipLevels);
    }

    void generateMipmap(VkImage image, int32_t texWidth, int32_t texHeight, uint32_t mipLevels)
    {
